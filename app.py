...
def homepage():
    ...
    return render_template("posts/listPost.html", posts=posts)
...
def tags_new_form():
    ...
    return render_template('tags/newTags.html', posts=posts)
...
def tags_edit_form(tag_id):
    tag = Tag.query.get_or_404(tag_id)
    posts = Post.query.all()
    return render_template('tags/editTags.html', tag=tag, posts=posts)
